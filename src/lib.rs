...
#[derive(Debug)]
pub struct NextPersonaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NextPersonaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NextPersona processing");
    
    let mut processor = NextPersonaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NextPersonaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NextPersonaProcessor::new(false);
